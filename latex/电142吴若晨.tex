...
\centering 
\subfigure[subfigure 1-1]{\label{fig:subfig:a}
\includegraphics[width=7cm,height=5cm]{img/yolo/1.png}}
\hspace{0.01\linewidth}
\subfigure[subfigure
 1-2]{\label{fig:subfig:b}
\includegraphics[width=7cm,height=5cm]{img/yolo/2.png}}

\vfill

\subfigure[subfigure 2-1]{\label{fig:subfig:a}
\includegraphics[width=7cm,height=5cm]{img/yolo/3.png}}
\hspace{0.01\linewidth}
\subfigure[subfigure
 2-2]{\label{fig:subfig:b}
\includegraphics[width=7cm,height=5cm]{img/yolo/4.png}}
\caption{YOLOv3检测行人}
