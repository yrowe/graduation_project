...
\subsubsection{检测实例}
由于本毕设重点并不是传统方法，所以我并没有选择复现整体算法流程，并没有训练分类器的过程。而是直接调用OpenCV库训练好的HOG+SVM接口进行测试，在CUHK Occlusion Dataset数据集测试结果，部分如图\ref{fig:hog}所示。

\begin{figure}[h]
\centering 
\subfigure[set00-occ/4.jpg]{\label{fig:subfig:a}
\includegraphics[width=7cm,height=5cm]{img/hog/1.jpg}}
\hspace{0.01\linewidth}
\subfigure[set03-occ/2.jpg]{\label{fig:subfig:b}
\includegraphics[width=7cm,height=5cm]{img/hog/2.jpg}}

\vfill

\subfigure[set06-occ/144.jpg]{\label{fig:subfig:a}
\includegraphics[width=7cm,height=5cm]{img/hog/3.jpg}}
\hspace{0.01\linewidth}
\subfigure[set08-occ/4.jpg]{\label{fig:subfig:b}
